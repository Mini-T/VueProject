<template>
<div class="wrapper" v-if="!datasloaded.isEmpty">
...
export default {
  ...
  let datasloaded = false
		const bearerToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjM2MDQ0NjE4LCJleHAiOjE2Mzg2MzY2MTh9.L3GsjGPD6XaEPdjt6 AVNRHXmjhXXWBcI2LyU3DjwP8E'
    axios
