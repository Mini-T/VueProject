<template>
  <div class="slider">
    <h1 class="styitle">{{ musicstyle1 }}</h1>
    <div class="wrapcontainer">
      <button
        class="slidebtn"
        :class="{ mousedownbutton: clicked }"
        @mouseup="clicked = false"
        @click="prev1"
        @mousedown="clicked = true"
      >
        <i class="gg-chevron-left fleche"></i>
      </button>
      <div
        class="wrapper"
        :style="{ transform: `translateX(${slideIndex1}px)` }"
      >
        <ConcertsArtist
          :artiste="artiste"
      ...
      <button class="slidebtn next" @click="next1" :class="{ mousedownbutton: clicked }"
        @mouseup="clicked = false" @mousedown="clicked = true">
        <i class="gg-chevron-right"></i>
      </button>
    </div>
  </div>
  <div class="slider">
    <h1 class="styitle">{{ musicstyle2 }}</h1>
    <div class="wrapcontainer">
      <button class="slidebtn" @click="prev2" :class="{ mousedownbutton: clicked }"
        @mouseup="clicked = false" @mousedown="clicked = true">
        <i class="gg-chevron-left"></i>
      </button>
      <div
        class="wrapper"
        :style="{ transform: `translateX(${slideIndex2}px)` }"
      >
        <ConcertsArtist
          :artiste="artiste"
      ...
      <button class="slidebtn next" @click="next2" :class="{ mousedownbutton: clicked }"
        @mouseup="clicked = false" @mousedown="clicked = true">
        <i class="gg-chevron-right"></i>
      </button>
    </div>
  ...
  <div class="slider">
    <h1 class="styitle">{{ musicstyle3 }}</h1>
    <div class="wrapcontainer">
      <button class="slidebtn" @click="prev3" :class="{ mousedownbutton: clicked }"
        @mouseup="clicked = false" @mousedown="clicked = true">
        <i class="gg-chevron-left"></i>
      </button>
      <div
        class="wrapper"
        :style="{ transform: `translateX(${slideIndex3}px)` }"
      >
        <ConcertsArtist
          :artiste="artiste"
      ...
      <button class="slidebtn next" @click="next3" :class="{ mousedownbutton: clicked }"
        @mouseup="clicked = false" @mousedown="clicked = true">
        <i class="gg-chevron-right"></i>
      </button>
    </div>
...
.cardconcerts.longer {
  ...
  align-items: center;
  background-image: url("/images/Freeze.jfif");
...
.wrapper {
  transition: all cubic-bezier(1, -0.13, 0.07, 1.13) 400ms;
  position: relative;
  display: flex;
  align-items: center;
}
