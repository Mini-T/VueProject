...
function useStore (key) {
  ...
  return vue_runtime_esmBundler.inject(key !== null ? key : storeKey)
}
...
function resetStoreState (store, state, hot) {
  ...
  store._state = vue_runtime_esmBundler.reactive({
    data: state
  });
...
function enableStrictMode (store) {
  vue_runtime_esmBundler.watch(function () { return store._state.data; }, function () {
...
Store.prototype.watch = function watch$1 (getter, cb, options) {
    var this$1$1 = this;
  return vue_runtime_esmBundler.watch(function () { return getter(this$1$1.state, this$1$1.getters); }, cb, Object.assign({}, options))
};
